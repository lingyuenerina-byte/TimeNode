...
2. **Dependency Setup**: The build script automatically bundles resources. You MUST download `ffmpeg.exe` and place it directly into the **`src-tauri/binaries/`** directory.
3. **Debug**: `npm run tauri dev`
